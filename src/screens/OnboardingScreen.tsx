...
// Mock only — this prototype has no real Account Aggregator integration.
// "Connect" just simulates success and returns to Home, matching the source
// design's own onClick={{goHome}} behavior.
  ...
  return (
    <View style={styles.screen}>
      ...
      <View style={styles.aaPill}>
        <Text style={styles.aaPillText}>Powered by India's Account Aggregator Framework</Text>
      </View>
...
const styles = StyleSheet.create({
  screen: { flex: 1, backgroundColor: colors.screenBg, padding: 24, paddingTop: 24 },
